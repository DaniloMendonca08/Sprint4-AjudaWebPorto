...
export const paragrafoRevisoes = "A ideia com essas revisões breves é fazer com que o usuário ao inves de abrir diretamente um chamado, tenha uma série de perguntas técnicas e recomendações para fazer no veiculo para identificar um possivel problema, com isso, vamos fazer com que um simples serviço que pode ser feito por uma pessoa física seja realizado, ao inves de ser chamado um guincho desnecessariamente."
